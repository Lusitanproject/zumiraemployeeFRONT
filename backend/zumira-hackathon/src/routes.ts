...
import { ListFeedbackController } from "./controllers/assessment/feedback/ListFeedbacksController";
...
router.get("/assessments/feedback", isAuthenticated, new ListFeedbackController().handle);
