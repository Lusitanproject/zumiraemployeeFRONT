...
CREATE TABLE "assessments" (
    ...
    "description" TEXT NOT NULL,
    "assessment_scale_id" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "self_monitoring_scales" (
    "self_monitoring_id" TEXT NOT NULL,
    "assessment_scale_id" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "self_monitoring_scales_pkey" PRIMARY KEY ("self_monitoring_id","assessment_scale_id")
);
...
-- AddForeignKey
ALTER TABLE "assessments" ADD CONSTRAINT "assessments_assessment_scale_id_fkey" FOREIGN KEY ("assessment_scale_id") REFERENCES "assessment_scales"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "self_monitoring_scales" ADD CONSTRAINT "self_monitoring_scales_self_monitoring_id_fkey" FOREIGN KEY ("self_monitoring_id") REFERENCES "self_monitoring_blocks"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "self_monitoring_scales" ADD CONSTRAINT "self_monitoring_scales_assessment_scale_id_fkey" FOREIGN KEY ("assessment_scale_id") REFERENCES "assessment_scales"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
