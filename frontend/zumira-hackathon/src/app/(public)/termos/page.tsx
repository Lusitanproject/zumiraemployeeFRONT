  ...
  return (
    <article className="relative max-w-4xl mx-auto px-4 font-sans text-gray-700">
      ...
      <header className="mb-12">
        <h1 className="text-[1.625rem] md:text-3xl font-semibold tracking-tight text-gray-900">
      ...
      <section className="space-y-10">
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">1. Finalidade</h2>
          ...
          <ul className="list-disc list-inside mt-4 space-y-2">
            <li className="text-sm text-gray-700">Realizar triagens de saúde mental e avaliações psicossociais;</li>
            <li className="text-sm text-gray-700">Gerar relatórios de bem-estar e orientações personalizadas;</li>
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">2. Tipos de Dados Coletados</h2>
          <p className="text-sm leading-6 text-gray-700">A Zumira poderá coletar e tratar os seguintes dados:</p>
          <ul className="list-disc list-inside mt-4 space-y-2">
            <li className="text-sm text-gray-700">
              Informações cadastrais (nome, e-mail, data de nascimento, nacionalidade, profissão);
            </li>
            <li className="text-sm text-gray-700">Informações fornecidas nas interações com a assistente virtual;</li>
            <li className="text-sm text-gray-700">Respostas a questionários e escalas de bem-estar psicológico;</li>
            <li className="text-sm text-gray-700">Informações de navegação, de forma anonimizada.</li>
          </ul>
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">3. Compartilhamento de Dados</h2>
          <p className="text-sm leading-6 text-gray-700">
        ...
        <div>
          ...
          <ul className="list-disc list-inside mt-4 space-y-2">
            <li className="text-sm text-gray-700">Confirmar a existência de tratamento;</li>
            <li className="text-sm text-gray-700">Acessar, corrigir ou atualizar informações;</li>
            <li className="text-sm text-gray-700">Revogar o consentimento a qualquer momento;</li>
            <li className="text-sm text-gray-700">Solicitar a exclusão dos dados pessoais.</li>
          </ul>
          <p className="mt-4 text-sm leading-6 text-gray-700">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">5. Segurança da Informação</h2>
          <p className="text-sm leading-6 text-gray-700">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">6. Consentimento</h2>
          <p className="text-sm leading-6 text-gray-700">Ao continuar utilizando a plataforma, você declara que:</p>
          <ul className="list-disc list-inside mt-4 space-y-2">
            <li className="text-sm text-gray-700">Leu, compreendeu e concorda com os termos deste documento;</li>
            <li className="text-sm text-gray-700">
      ...
      <section className="space-y-10">
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">1. Natureza da Plataforma</h2>
          <p className="text-sm leading-6 text-gray-700">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">2. Limitação dos Serviços</h2>
          <p className="text-sm leading-6 text-gray-700">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">4. Responsabilidades do Usuário</h2>
          <ul className="list-disc list-inside mt-4 space-y-2">
            <li className="text-sm text-gray-700">Utilizar a plataforma de forma ética;</li>
            <li className="text-sm text-gray-700">Fornecer informações verdadeiras;</li>
            <li className="text-sm text-gray-700">Buscar atendimento humano sempre que necessário.</li>
            <li className="text-sm text-gray-700">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">5. Privacidade e Proteção de Dados</h2>
          <p className="text-sm leading-6 text-gray-700">
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">8. Aceite dos Termos</h2>
          <p className="text-sm leading-6 text-gray-700">Ao utilizar a plataforma Zumira, o usuário declara que:</p>
          <ul className="list-disc list-inside mt-4 space-y-2">
            <li className="text-sm text-gray-700">
        ...
        <p className="text-sm text-gray-500">Versão: 1.0 | Vigência: 28/04/2026</p>
      </section>
    </article>
  );
}
