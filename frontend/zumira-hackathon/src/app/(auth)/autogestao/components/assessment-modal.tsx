    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader className="relative pt-16">
          ...
          <AlertDialogCancel
            className="w-8 h-8 absolute flex items-center justify-center border-0"
          >
          ...
          <AlertDialogDescription className="text-sm leading-5 text-center text-gray-700 mb-8">{summary}</AlertDialogDescription>
        </AlertDialogHeader>
