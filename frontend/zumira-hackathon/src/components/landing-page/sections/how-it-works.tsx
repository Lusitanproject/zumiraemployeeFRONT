    ...
    <section className="w-full px-4 py-28 sm:pb-32 bg-white">
      <div className="w-full max-w-[82.5rem] mx-auto flex flex-col sm:flex-row items-start sm:items-center sm:justify-between">
        <div className="flex flex-col w-full mb-16 md:mb-0 md:w-5/12">
          <h2 className="text-3xl font-bold leading-[1.25] sm:text-4xl sm:leading-[1.2] mb-6 text-slate-800">Como funciona?</h2>

          <p className="sm:max-w-[600px] text-slate-600 mb-4">Sua empresa contrata a Zumira e disponibiliza gratuitamente aos colaboradores, uma plataforma que acolhe, aplica instrumentos psicológicos confiáveis, gera devolutivas automatizadas e, quando necessário, orienta ações de desenvolvimento e a busca por profissionais da saúde especializados.</p>
