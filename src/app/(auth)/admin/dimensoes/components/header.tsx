...
export function Header() {
  return (
    <div className="flex items-center justify-between py-4 border-b border-border-100">
      <h3 className="font-bold text-2xl text-text-700">Dimensões Psicológicas</h3>
      <Link
        ...
        href="/admin/dimensoes/novo"
      >
        <CirclePlus className="text-text-300 size-6" />
        <span className="text-sm text-text-500 font-medium">Criar nova dimensão</span>
      </Link>
    </div>
  );
}
